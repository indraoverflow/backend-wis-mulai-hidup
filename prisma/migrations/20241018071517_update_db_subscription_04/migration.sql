...
CREATE TABLE "wedding_reception" (
    "id" BIGSERIAL NOT NULL,
    "title_reception" TEXT NOT NULL,
    "name_man" TEXT NOT NULL,
    "nickname_man" TEXT NOT NULL,
    "prefix_man" TEXT NOT NULL,
    "title_man" TEXT NOT NULL,
    "birthdate_man" TIMESTAMP(3) NOT NULL,
    "father_man" TEXT NOT NULL,
    "mother_man" TEXT NOT NULL,
    "description_man" TEXT NOT NULL,
    "prefix_woman" TEXT NOT NULL,
    "name_woman" TEXT NOT NULL,
    "nickname_woman" TEXT NOT NULL,
    "title_woman" TEXT NOT NULL,
    "birthdate_woman" TIMESTAMP(3) NOT NULL,
    "father_woman" TEXT NOT NULL,
    "mother_woman" TEXT NOT NULL,
    "description_woman" TEXT NOT NULL,
...
CREATE TABLE "guest_message" (
    ...
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
    "wedding_unique_id" VARCHAR,
    "guest_unique_id" VARCHAR,
...
-- AddForeignKey
ALTER TABLE "guest_message" ADD CONSTRAINT "guest_message_wedding_reception_id_fkey" FOREIGN KEY ("wedding_unique_id") REFERENCES "wedding_reception"("unique_id") ON DELETE CASCADE ON UPDATE CASCADE;
